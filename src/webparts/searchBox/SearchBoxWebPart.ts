...
export default class SearchBoxWebPart extends BaseClientSideWebPart<ISearchBoxWebPartProps> implements IDynamicDataCallables {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<ISearchBoxContainerProps> = React.createElement(
      SearchBoxContainer, {
        ...
        searchboxtitleText: this.properties.searchboxtitleText,
        defaultSearchBoxIdentifier: this.properties.defaultSearchBoxIdentifier,
  ...
  private _getSearchBehaviorOptionsFields(): IPropertyPaneField<any>[] {
    ...
    let searchBehaviorOptionsFields: IPropertyPaneField<any>[]  = [
      ...
      PropertyPaneHorizontalRule(),
      PropertyPaneTextField('searchboxtitleText', {
        label: strings.SearchBoxTitleTextLabel
      }),
      PropertyPaneHorizontalRule(),
      PropertyPaneTextField('defaultSearchBoxIdentifier', {
        label: strings.DefaultSearchBoxIdentifierLabel
      }),
      PropertyPaneHorizontalRule(),
