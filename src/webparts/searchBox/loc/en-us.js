define([], function() {
  return {
    ...
    "SearchInputTitle": "Welcome to the AQC Knowledge Center",
    ...
    "SearchBoxTitleTextLabel": "Title text of search box",
    "DefaultSearchBoxIdentifierLabel": "Default Search Box Identifier",
    "DynamicData": {
